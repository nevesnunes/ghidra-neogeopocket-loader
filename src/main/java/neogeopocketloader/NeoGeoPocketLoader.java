...
public class NeoGeoPocketLoader extends AbstractLibrarySupportLoader {
	...
	protected void load(ByteProvider provider, LoadSpec loadSpec, List<Option> options,
		...
		createNamedData(fpa,  program, 0x0001L, "Port1", ByteDataType.dataType, log);
		createNamedData(fpa,  program, 0x0004L, "Port1_Ctrl", ByteDataType.dataType, log);
		createNamedData(fpa,  program, 0x0006L, "Port2", ByteDataType.dataType, log);
		createNamedData(fpa,  program, 0x0009L, "Port2_Func", ByteDataType.dataType, log);
		createNamedData(fpa,  program, 0x000DL, "Port5", ByteDataType.dataType, log);
		createNamedData(fpa,  program, 0x0010L, "Port5_Ctrl", ByteDataType.dataType, log);
		createNamedData(fpa,  program, 0x0011L, "Port5_Func", ByteDataType.dataType, log);
		createNamedData(fpa,  program, 0x0012L, "Port6", ByteDataType.dataType, log);
		createNamedData(fpa,  program, 0x0013L, "Port7", ByteDataType.dataType, log);
		createNamedData(fpa,  program, 0x0015L, "Port6_Func", ByteDataType.dataType, log);
		createNamedData(fpa,  program, 0x0016L, "Port7_Ctrl", ByteDataType.dataType, log);
		createNamedData(fpa,  program, 0x0017L, "Port7_Func", ByteDataType.dataType, log);
		createNamedData(fpa,  program, 0x0018L, "Port8", ByteDataType.dataType, log);
		createNamedData(fpa,  program, 0x0019L, "Port9", ByteDataType.dataType, log);
		createNamedData(fpa,  program, 0x001AL, "Port8_Ctrl", ByteDataType.dataType, log);
		createNamedData(fpa,  program, 0x001BL, "Port8_Func", ByteDataType.dataType, log);
		createNamedData(fpa,  program, 0x001EL, "PortA", ByteDataType.dataType, log);
		createNamedData(fpa,  program, 0x001FL, "PortB", ByteDataType.dataType, log);
		createNamedData(fpa,  program, 0x0020L, "TimerOp_Ctrl", ByteDataType.dataType, log);
		createNamedData(fpa,  program, 0x0022L, "Timer_Reg0", ByteDataType.dataType, log);
		createNamedData(fpa,  program, 0x0023L, "Timer_Reg1", ByteDataType.dataType, log);
		createNamedData(fpa,  program, 0x0024L, "Timer01_Mode", ByteDataType.dataType, log);
		createNamedData(fpa,  program, 0x0025L, "Timer_FF_Ctrl", ByteDataType.dataType, log);
		createNamedData(fpa,  program, 0x0026L, "Timer_Reg2", ByteDataType.dataType, log);
		createNamedData(fpa,  program, 0x0027L, "Timer_Reg3", ByteDataType.dataType, log);
		createNamedData(fpa,  program, 0x0028L, "Timer23_Mode", ByteDataType.dataType, log);
		createNamedData(fpa,  program, 0x0029L, "TRDC", ByteDataType.dataType, log);
		createNamedData(fpa,  program, 0x0030L, "Timer_Reg45", DWordDataType.dataType, log);
		createNamedData(fpa,  program, 0x0034L, "Capture12", DWordDataType.dataType, log);
		createNamedData(fpa,  program, 0x0038L, "Timer4_Mode", ByteDataType.dataType, log);
		createNamedData(fpa,  program, 0x0039L, "Timer4_FF_Ctrl", ByteDataType.dataType, log);
		createNamedData(fpa,  program, 0x003AL, "Timer45_Ctrl", ByteDataType.dataType, log);
		createNamedData(fpa,  program, 0x003CL, "Mem_Start_Reg01", DWordDataType.dataType, log);
		createNamedData(fpa,  program, 0x0040L, "Timer_Reg67", DWordDataType.dataType, log);
		createNamedData(fpa,  program, 0x0044L, "Capture34", DWordDataType.dataType, log);
		createNamedData(fpa,  program, 0x0048L, "Timer5_Mode", ByteDataType.dataType, log);
		createNamedData(fpa,  program, 0x0049L, "Timer5_FF_Ctrl", ByteDataType.dataType, log);
		createNamedData(fpa,  program, 0x004CL, "Pattern_Gen_Reg", WordDataType.dataType, log);
		createNamedData(fpa,  program, 0x004EL, "Pattern_Gen01_Ctrl", ByteDataType.dataType, log);
		createNamedData(fpa,  program, 0x0050L, "Serial0_Buffer", ByteDataType.dataType, log);
		createNamedData(fpa,  program, 0x0051L, "Serial0_Ctrl", ByteDataType.dataType, log);
		createNamedData(fpa,  program, 0x0052L, "Serial0_Mode_Ctrl", ByteDataType.dataType, log);
		createNamedData(fpa,  program, 0x0053L, "BR0_Ctrl", ByteDataType.dataType, log);
		createNamedData(fpa,  program, 0x0054L, "Serial1_Buffer", ByteDataType.dataType, log);
		createNamedData(fpa,  program, 0x0055L, "Serial1_Ctrl", ByteDataType.dataType, log);
		createNamedData(fpa,  program, 0x0056L, "Serial1_Mode_Ctrl", ByteDataType.dataType, log);
		createNamedData(fpa,  program, 0x0057L, "BR1_Ctrl", ByteDataType.dataType, log);
		createNamedData(fpa,  program, 0x0058L, "ODE", ByteDataType.dataType, log);
		createNamedData(fpa,  program, 0x005AL, "DREF_Ctrl", ByteDataType.dataType, log);
		createNamedData(fpa,  program, 0x005BL, "DMEM_Ctrl", ByteDataType.dataType, log);
		createNamedData(fpa,  program, 0x005CL, "Mem_Start_Reg23", DWordDataType.dataType, log);
		createNamedArray(fpa, program, 0x0060L, "AD_Reg", 8, ByteDataType.dataType, log);
		createNamedData(fpa,  program, 0x0068L, "Bus_Chip_Sel", DWordDataType.dataType, log);
		createNamedData(fpa,  program, 0x006CL, "Bus_Extra_Chip_Sel", ByteDataType.dataType, log);
		createNamedData(fpa,  program, 0x006DL, "AD_Mode", ByteDataType.dataType, log);
		createNamedData(fpa,  program, 0x006EL, "Watch_Dog_Mode", ByteDataType.dataType, log);
		createNamedData(fpa,  program, 0x006FL, "Watch_Dog_Ctrl", ByteDataType.dataType, log);
